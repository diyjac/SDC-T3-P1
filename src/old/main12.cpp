      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          else
          {
            ...
            t2.push_back(double(num_points*1.25));
            nd.push_back(vy[0]);
          ...
          if (timestep > 50 && not lanechange) {
            ...
            for (int k = 0; k<sensor_fusion.size(); k++) {
              ...
              double vids = double(vid[5]) - ourcarsd[0] + 10;
              ...
              if (vids > 0.) {
                if (vidd < 12. && vidd > 0.) {
                  if (vidd <= 3.5) {
                    lanestr = "0";
                    cout << "[" << vid[0] << ":(" << vid[5] << ":" << vid[6] << "):(" << vidsd[0] << ":" << vidsd[1] << "):" << vids << ":" << lanestr << "],";
                    lanes[0].push_back(vids);
                  }
                  if (vidd > 3.5 && vidd <= 4.5) {
                    lanestr = "0,1";
                    cout << "[" << vid[0] << ":(" << vid[5] << ":" << vid[6] << "):(" << vidsd[0] << ":" << vidsd[1] << "):" << vids << ":" << lanestr << "],";
                    lanes[0].push_back(vids);
                    lanes[1].push_back(vids);
                  }
                  if (vidd > 4.5 && vidd <= 7.5) {
                    lanestr = "1";
                    cout << "[" << vid[0] << ":(" << vid[5] << ":" << vid[6] << "):(" << vidsd[0] << ":" << vidsd[1] << "):" << vids << ":" << lanestr << "],";
                    lanes[1].push_back(vids);
                  }
                  if (vidd > 7.5 && vidd <= 8.5) {
                    lanestr = "1,2";
                    cout << "[" << vid[0] << ":(" << vid[5] << ":" << vid[6] << "):(" << vidsd[0] << ":" << vidsd[1] << "):" << vids << ":" << lanestr << "],";
                    lanes[1].push_back(vids);
            ...
            for (int lane = 0; lane<3; lane++) {
              ...
              if (lanes[lane].size() > 0) {
                ...
                if (lanes[bestlane].size() > 0 && (lanes[bestlane][0] < lanes[lane][0])) {
                  ...
                  if (lanes[ourlane].size() > 0 and lanes[ourlane][0] < 50.) {
                    bestlane = lane;
                  }
                }
